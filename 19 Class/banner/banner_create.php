            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li><a href="banner_list.php"><i class="icon-image-compare position-left"></i> Banner</a>
                            </li>
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal mt-10" action="../controller/banner_control.php" method="POST">
