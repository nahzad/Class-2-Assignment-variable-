...
$is_it_hp_brand            = true; // Data types Boolean
$number_of_monitors        = 3; // Data type INT
$is_monitors_condition_new = False; // Data type Boolean
$display_size              = 15.6; // Data type Float/double
$has_vga_cable             = true; // Data type boolean
$sell_price                = 8000; // Data type INT